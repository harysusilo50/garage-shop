                ...
                <div class="row">
                    <div class="card info-card customers-card">
                        <div class="card-body p-3">
                            <h5 class="card-title">List <span>| Brand</span></h5>
                            <div class="d-lg-flex justify-content-lg-between mb-3 d-block">
                                ...
                                <form action="{{ route('brand.index') }}" method="GET">
                                    <div class="input-group my-2">
                                        <input type="text" class="form-control" placeholder="Search Brand" name="search"
                                            aria-label="Search Brand" value="{{ $search ?? '' }}"
